 ...
 */
public class MultiYYNewsListAdapter extends MultiItemAdapter<NewsContentlistEntity> {

    Object pictureTag;
    public static int TYPE_ONE = 100;
    public static int TYPE_TWO = 101;

    public MultiYYNewsListAdapter(Context context, List<NewsContentlistEntity> datas,
                                  MultiItemTypeSupport<NewsContentlistEntity> multiItemTypeSupport) {
    ...
    private void setDataTwo(BaseRecyclerHolder holder, NewsContentlistEntity item) {
    ...
    private void setDataOne(BaseRecyclerHolder holder, NewsContentlistEntity item) {
        TextView tvTime = holder.getView(R.id.tv_time);
        TextView tvTitle = holder.getView(R.id.tv_title);
        TextView tvSource = holder.getView(R.id.tv_source);
