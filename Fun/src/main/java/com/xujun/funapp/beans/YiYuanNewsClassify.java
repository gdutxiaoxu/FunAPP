...
public class YiYuanNewsClassify {
    ...
    public static class ShowapiResBodyEntity {
        ...
        public static class ChannelListEntity implements Parcelable {
            ...
            public static final Creator<ChannelListEntity> CREATOR = new
                    Creator<ChannelListEntity>() {
                @Override
                public ChannelListEntity createFromParcel(Parcel in) {
                    return new ChannelListEntity(in);
                }

                @Override
                public ChannelListEntity[] newArray(int size) {
                    return new ChannelListEntity[size];
                }
            };
